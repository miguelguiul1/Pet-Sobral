...
// PLACEHOLDERS: substituir por 3 avaliações reais do Google (com autorização do autor).
            ...
            <li key={tema}>
              <figure className="flex h-full flex-col rounded-cartao bg-cartao p-6 ring-1 ring-border">
                ...
                <figcaption className="mt-5 text-sm text-tinta-suave">
                  <Confirmar curto="Nome do cliente">[SUBSTITUIR pelo nome exibido no Google, com autorização]</Confirmar>{' '}
                  · Avaliação no Google
                </figcaption>
              </figure>
            </li>
