...
const pares = [
  ...
  ['mostarda claro / terracota escuro (títulos do rodapé)', '#f3e2b8', '#7f3a1f', 4.5],
  ['mostarda / terracota escuro (logo do rodapé, texto grande 3:1)', '#d9a441', '#7f3a1f', 3],
  ['mostarda / tinta (condomínios, texto grande)', '#d9a441', '#1e2b25', 3],
